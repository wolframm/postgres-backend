...
import '../../../core/v3/extension.pb.dart' as $2;
import 'string.pb.dart' as $3;
...
class Matcher_OnMatch extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Matcher.OnMatch', package: const $pb.PackageName(_omitMessageNames ? '' : 'xds.type.matcher.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<Matcher>(1, _omitFieldNames ? '' : 'matcher', subBuilder: Matcher.create)
    ..aOM<$2.TypedExtensionConfig>(2, _omitFieldNames ? '' : 'action', subBuilder: $2.TypedExtensionConfig.create)
  ...
  @$pb.TagNumber(2)
  $2.TypedExtensionConfig get action => $_getN(1);
  @$pb.TagNumber(2)
  set action($2.TypedExtensionConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAction() => $_has(1);
  @$pb.TagNumber(2)
  void clearAction() => clearField(2);
  @$pb.TagNumber(2)
  $2.TypedExtensionConfig ensureAction() => $_ensure(1);
}
...
class Matcher_MatcherList_Predicate_SinglePredicate extends $pb.GeneratedMessage {
  factory Matcher_MatcherList_Predicate_SinglePredicate({
    $2.TypedExtensionConfig? input,
    $3.StringMatcher? valueMatch,
    $2.TypedExtensionConfig? customMatch,
  }) {
    final $result = create();
    if (input != null) {
      $result.input = input;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Matcher.MatcherList.Predicate.SinglePredicate', package: const $pb.PackageName(_omitMessageNames ? '' : 'xds.type.matcher.v3'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<$2.TypedExtensionConfig>(1, _omitFieldNames ? '' : 'input', subBuilder: $2.TypedExtensionConfig.create)
    ..aOM<$3.StringMatcher>(2, _omitFieldNames ? '' : 'valueMatch', subBuilder: $3.StringMatcher.create)
    ..aOM<$2.TypedExtensionConfig>(3, _omitFieldNames ? '' : 'customMatch', subBuilder: $2.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $2.TypedExtensionConfig get input => $_getN(0);
  @$pb.TagNumber(1)
  set input($2.TypedExtensionConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasInput() => $_has(0);
  @$pb.TagNumber(1)
  void clearInput() => clearField(1);
  @$pb.TagNumber(1)
  $2.TypedExtensionConfig ensureInput() => $_ensure(0);

  /// Built-in string matcher.
  @$pb.TagNumber(2)
  $3.StringMatcher get valueMatch => $_getN(1);
  @$pb.TagNumber(2)
  set valueMatch($3.StringMatcher v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValueMatch() => $_has(1);
  @$pb.TagNumber(2)
  void clearValueMatch() => clearField(2);
  @$pb.TagNumber(2)
  $3.StringMatcher ensureValueMatch() => $_ensure(1);

  /// Extension for custom matching logic.
  /// [#extension-category: envoy.matching.input_matchers]
  @$pb.TagNumber(3)
  $2.TypedExtensionConfig get customMatch => $_getN(2);
  @$pb.TagNumber(3)
  set customMatch($2.TypedExtensionConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCustomMatch() => $_has(2);
  @$pb.TagNumber(3)
  void clearCustomMatch() => clearField(3);
  @$pb.TagNumber(3)
  $2.TypedExtensionConfig ensureCustomMatch() => $_ensure(2);
}
...
class Matcher_MatcherList_Predicate_PredicateList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Matcher.MatcherList.Predicate.PredicateList', package: const $pb.PackageName(_omitMessageNames ? '' : 'xds.type.matcher.v3'), createEmptyInstance: create)
...
class Matcher_MatcherList_Predicate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Matcher.MatcherList.Predicate', package: const $pb.PackageName(_omitMessageNames ? '' : 'xds.type.matcher.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4])
...
class Matcher_MatcherList_FieldMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Matcher.MatcherList.FieldMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'xds.type.matcher.v3'), createEmptyInstance: create)
...
class Matcher_MatcherList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Matcher.MatcherList', package: const $pb.PackageName(_omitMessageNames ? '' : 'xds.type.matcher.v3'), createEmptyInstance: create)
...
class Matcher_MatcherTree_MatchMap extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Matcher.MatcherTree.MatchMap', package: const $pb.PackageName(_omitMessageNames ? '' : 'xds.type.matcher.v3'), createEmptyInstance: create)
    ..m<$core.String, Matcher_OnMatch>(1, _omitFieldNames ? '' : 'map', entryClassName: 'Matcher.MatcherTree.MatchMap.MapEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: Matcher_OnMatch.create, valueDefaultOrMaker: Matcher_OnMatch.getDefault, packageName: const $pb.PackageName('xds.type.matcher.v3'))
    ..hasRequiredFields = false
  ;
...
class Matcher_MatcherTree extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Matcher.MatcherTree', package: const $pb.PackageName(_omitMessageNames ? '' : 'xds.type.matcher.v3'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
    ..aOM<$2.TypedExtensionConfig>(1, _omitFieldNames ? '' : 'input', subBuilder: $2.TypedExtensionConfig.create)
    ...
    ..aOM<$2.TypedExtensionConfig>(4, _omitFieldNames ? '' : 'customMatch', subBuilder: $2.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  /// Extension for custom matching logic.
  @$pb.TagNumber(4)
  $2.TypedExtensionConfig get customMatch => $_getN(3);
  @$pb.TagNumber(4)
  set customMatch($2.TypedExtensionConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCustomMatch() => $_has(3);
  @$pb.TagNumber(4)
  void clearCustomMatch() => clearField(4);
  @$pb.TagNumber(4)
  $2.TypedExtensionConfig ensureCustomMatch() => $_ensure(3);
}
...
class Matcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Matcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'xds.type.matcher.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2])
