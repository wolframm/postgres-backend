...
class StringMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StringMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'xds.type.matcher.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 5, 7])
...
class ListStringMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListStringMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'xds.type.matcher.v3'), createEmptyInstance: create)
