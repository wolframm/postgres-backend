...
class TypedExtensionConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TypedExtensionConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'xds.core.v3'), createEmptyInstance: create)
