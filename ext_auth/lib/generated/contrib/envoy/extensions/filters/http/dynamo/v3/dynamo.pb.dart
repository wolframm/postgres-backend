...
class Dynamo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Dynamo', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.dynamo.v3'), createEmptyInstance: create)
