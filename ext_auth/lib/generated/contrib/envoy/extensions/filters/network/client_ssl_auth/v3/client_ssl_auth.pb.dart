...
import '../../../../../../../envoy/config/core/v3/address.pb.dart' as $1;
...
class ClientSSLAuth extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientSSLAuth', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.client_ssl_auth.v3'), createEmptyInstance: create)
