...
class KafkaBroker extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KafkaBroker', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.kafka_broker.v3'), createEmptyInstance: create)
    ..oo(0, [3])
...
class IdBasedBrokerRewriteSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IdBasedBrokerRewriteSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.kafka_broker.v3'), createEmptyInstance: create)
...
class IdBasedBrokerRewriteRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IdBasedBrokerRewriteRule', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.kafka_broker.v3'), createEmptyInstance: create)
