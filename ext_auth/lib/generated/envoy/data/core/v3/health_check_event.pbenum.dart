...
class HealthCheckFailureType extends $pb.ProtobufEnum {
  ...
  static const HealthCheckFailureType NETWORK_TIMEOUT = HealthCheckFailureType._(3, _omitEnumNames ? '' : 'NETWORK_TIMEOUT');
...
class HealthCheckerType extends $pb.ProtobufEnum {
  ...
  static const HealthCheckerType THRIFT = HealthCheckerType._(4, _omitEnumNames ? '' : 'THRIFT');
