...
class AccessLogType extends $pb.ProtobufEnum {
  static const AccessLogType NotSet = AccessLogType._(0, _omitEnumNames ? '' : 'NotSet');
  static const AccessLogType TcpUpstreamConnected = AccessLogType._(1, _omitEnumNames ? '' : 'TcpUpstreamConnected');
  static const AccessLogType TcpPeriodic = AccessLogType._(2, _omitEnumNames ? '' : 'TcpPeriodic');
  static const AccessLogType TcpConnectionEnd = AccessLogType._(3, _omitEnumNames ? '' : 'TcpConnectionEnd');
  static const AccessLogType DownstreamStart = AccessLogType._(4, _omitEnumNames ? '' : 'DownstreamStart');
  static const AccessLogType DownstreamPeriodic = AccessLogType._(5, _omitEnumNames ? '' : 'DownstreamPeriodic');
  static const AccessLogType DownstreamEnd = AccessLogType._(6, _omitEnumNames ? '' : 'DownstreamEnd');
  static const AccessLogType UpstreamPoolReady = AccessLogType._(7, _omitEnumNames ? '' : 'UpstreamPoolReady');
  static const AccessLogType UpstreamPeriodic = AccessLogType._(8, _omitEnumNames ? '' : 'UpstreamPeriodic');
  static const AccessLogType UpstreamEnd = AccessLogType._(9, _omitEnumNames ? '' : 'UpstreamEnd');
  static const AccessLogType DownstreamTunnelSuccessfullyEstablished = AccessLogType._(10, _omitEnumNames ? '' : 'DownstreamTunnelSuccessfullyEstablished');
  static const AccessLogType UdpTunnelUpstreamConnected = AccessLogType._(11, _omitEnumNames ? '' : 'UdpTunnelUpstreamConnected');
  static const AccessLogType UdpPeriodic = AccessLogType._(12, _omitEnumNames ? '' : 'UdpPeriodic');
  static const AccessLogType UdpSessionEnd = AccessLogType._(13, _omitEnumNames ? '' : 'UdpSessionEnd');

  static const $core.List<AccessLogType> values = <AccessLogType> [
    NotSet,
  ...
  static final $core.Map<$core.int, AccessLogType> _byValue = $pb.ProtobufEnum.initByValue(values);
  static AccessLogType? valueOf($core.int value) => _byValue[value];

  const AccessLogType._($core.int v, $core.String n) : super(v, n);
}
