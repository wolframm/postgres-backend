...
import '../../../api/v2/core/base.pbenum.dart' as $3;
...
class AccessLogCommon extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessLogCommon', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.accesslog.v2'), createEmptyInstance: create)
    ...
    ..m<$core.String, $4.Any>(21, _omitFieldNames ? '' : 'filterStateObjects', entryClassName: 'AccessLogCommon.FilterStateObjectsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $4.Any.create, valueDefaultOrMaker: $4.Any.getDefault, packageName: const $pb.PackageName('envoy.data.accesslog.v2'))
    ..hasRequiredFields = false
  ;
