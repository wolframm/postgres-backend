...
class Connection extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Connection', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.data.tap.v2alpha'), createEmptyInstance: create)
    ...
    ..aOM<$2.Address>(3, _omitFieldNames ? '' : 'remoteAddress', subBuilder: $2.Address.create)
  ...
  /// Local address.
  @$pb.TagNumber(2)
  $2.Address get localAddress => $_getN(0);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $2.Address ensureLocalAddress() => $_ensure(0);

  /// Remote address.
  @$pb.TagNumber(3)
  $2.Address get remoteAddress => $_getN(1);
  @$pb.TagNumber(3)
  set remoteAddress($2.Address v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRemoteAddress() => $_has(1);
  @$pb.TagNumber(3)
  void clearRemoteAddress() => clearField(3);
  @$pb.TagNumber(3)
  $2.Address ensureRemoteAddress() => $_ensure(1);
}
