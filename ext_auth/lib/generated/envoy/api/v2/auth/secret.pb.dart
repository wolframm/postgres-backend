...
import '../core/config_source.pb.dart' as $5;
...
class GenericSecret extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenericSecret', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.api.v2.auth'), createEmptyInstance: create)
    ..aOM<$2.DataSource>(1, _omitFieldNames ? '' : 'secret', subBuilder: $2.DataSource.create)
  ...
  @$pb.TagNumber(1)
  $2.DataSource get secret => $_getN(0);
  @$pb.TagNumber(1)
  set secret($2.DataSource v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSecret() => $_has(0);
  @$pb.TagNumber(1)
  void clearSecret() => clearField(1);
  @$pb.TagNumber(1)
  $2.DataSource ensureSecret() => $_ensure(0);
}
