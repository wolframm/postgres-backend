...
class AwsIamConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AwsIamConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.grpc_credential.v3'), createEmptyInstance: create)
