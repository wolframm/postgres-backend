...
class Redis extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Redis', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.health_checker.redis.v2'), createEmptyInstance: create)
