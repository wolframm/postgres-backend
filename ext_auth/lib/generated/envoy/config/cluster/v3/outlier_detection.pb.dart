...
class OutlierDetection extends $pb.GeneratedMessage {
  factory OutlierDetection({
    ...
    $5.Duration? maxEjectionTime,
    $5.Duration? maxEjectionTimeJitter,
    $0.BoolValue? successfulActiveHealthCheckUnejectHost,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OutlierDetection', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.cluster.v3'), createEmptyInstance: create)
    ...
    ..aOM<$5.Duration>(3, _omitFieldNames ? '' : 'baseEjectionTime', subBuilder: $5.Duration.create)
    ...
    ..aOM<$5.Duration>(21, _omitFieldNames ? '' : 'maxEjectionTime', subBuilder: $5.Duration.create)
    ..aOM<$5.Duration>(22, _omitFieldNames ? '' : 'maxEjectionTimeJitter', subBuilder: $5.Duration.create)
    ..aOM<$0.BoolValue>(23, _omitFieldNames ? '' : 'successfulActiveHealthCheckUnejectHost', subBuilder: $0.BoolValue.create)
  ...
  @$pb.TagNumber(3)
  $5.Duration get baseEjectionTime => $_getN(2);
  @$pb.TagNumber(3)
  set baseEjectionTime($5.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBaseEjectionTime() => $_has(2);
  @$pb.TagNumber(3)
  void clearBaseEjectionTime() => clearField(3);
  @$pb.TagNumber(3)
  $5.Duration ensureBaseEjectionTime() => $_ensure(2);
  ...
  @$pb.TagNumber(21)
  $5.Duration get maxEjectionTime => $_getN(20);
  @$pb.TagNumber(21)
  set maxEjectionTime($5.Duration v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasMaxEjectionTime() => $_has(20);
  @$pb.TagNumber(21)
  void clearMaxEjectionTime() => clearField(21);
  @$pb.TagNumber(21)
  $5.Duration ensureMaxEjectionTime() => $_ensure(20);
  ...
  /// Defaults to 0s.
  @$pb.TagNumber(22)
  $5.Duration get maxEjectionTimeJitter => $_getN(21);
  @$pb.TagNumber(22)
  set maxEjectionTimeJitter($5.Duration v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasMaxEjectionTimeJitter() => $_has(21);
  @$pb.TagNumber(22)
  void clearMaxEjectionTimeJitter() => clearField(22);
  @$pb.TagNumber(22)
  $5.Duration ensureMaxEjectionTimeJitter() => $_ensure(21);
  ...
  /// Defaults to true.
  @$pb.TagNumber(23)
  $0.BoolValue get successfulActiveHealthCheckUnejectHost => $_getN(22);
  @$pb.TagNumber(23)
  set successfulActiveHealthCheckUnejectHost($0.BoolValue v) { setField(23, v); }
  @$pb.TagNumber(23)
  ...
  @$pb.TagNumber(23)
  $0.BoolValue ensureSuccessfulActiveHealthCheckUnejectHost() => $_ensure(22);
}
