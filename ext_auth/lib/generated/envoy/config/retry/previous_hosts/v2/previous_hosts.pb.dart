...
class PreviousHostsPredicate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PreviousHostsPredicate', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.retry.previous_hosts.v2'), createEmptyInstance: create)
