...
class EventServiceConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EventServiceConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$14.GrpcService>(1, _omitFieldNames ? '' : 'grpcService', subBuilder: $14.GrpcService.create)
  ...
  @$pb.TagNumber(1)
  $14.GrpcService get grpcService => $_getN(0);
  @$pb.TagNumber(1)
  set grpcService($14.GrpcService v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasGrpcService() => $_has(0);
  @$pb.TagNumber(1)
  void clearGrpcService() => clearField(1);
  @$pb.TagNumber(1)
  $14.GrpcService ensureGrpcService() => $_ensure(0);
}
