...
import 'socket_option.pb.dart' as $2;
...
class TcpKeepalive extends $pb.GeneratedMessage {
  factory TcpKeepalive({
    $1.UInt32Value? keepaliveProbes,
    $1.UInt32Value? keepaliveTime,
    $1.UInt32Value? keepaliveInterval,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TcpKeepalive', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$1.UInt32Value>(1, _omitFieldNames ? '' : 'keepaliveProbes', subBuilder: $1.UInt32Value.create)
    ..aOM<$1.UInt32Value>(2, _omitFieldNames ? '' : 'keepaliveTime', subBuilder: $1.UInt32Value.create)
    ..aOM<$1.UInt32Value>(3, _omitFieldNames ? '' : 'keepaliveInterval', subBuilder: $1.UInt32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $1.UInt32Value get keepaliveProbes => $_getN(0);
  @$pb.TagNumber(1)
  set keepaliveProbes($1.UInt32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasKeepaliveProbes() => $_has(0);
  @$pb.TagNumber(1)
  void clearKeepaliveProbes() => clearField(1);
  @$pb.TagNumber(1)
  $1.UInt32Value ensureKeepaliveProbes() => $_ensure(0);

  /// The number of seconds a connection needs to be idle before keep-alive probes
  /// start being sent. Default is to use the OS level configuration (unless
  /// overridden, Linux defaults to 7200s (i.e., 2 hours.)
  @$pb.TagNumber(2)
  $1.UInt32Value get keepaliveTime => $_getN(1);
  @$pb.TagNumber(2)
  set keepaliveTime($1.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasKeepaliveTime() => $_has(1);
  @$pb.TagNumber(2)
  void clearKeepaliveTime() => clearField(2);
  @$pb.TagNumber(2)
  $1.UInt32Value ensureKeepaliveTime() => $_ensure(1);

  /// The number of seconds between keep-alive probes. Default is to use the OS
  /// level configuration (unless overridden, Linux defaults to 75s.)
  @$pb.TagNumber(3)
  $1.UInt32Value get keepaliveInterval => $_getN(2);
  @$pb.TagNumber(3)
  set keepaliveInterval($1.UInt32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasKeepaliveInterval() => $_has(2);
  @$pb.TagNumber(3)
  void clearKeepaliveInterval() => clearField(3);
  @$pb.TagNumber(3)
  $1.UInt32Value ensureKeepaliveInterval() => $_ensure(2);
}

class ExtraSourceAddress extends $pb.GeneratedMessage {
  factory ExtraSourceAddress({
    SocketAddress? address,
    $2.SocketOptionsOverride? socketOptions,
  }) {
    final $result = create();
    if (address != null) {
      $result.address = address;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExtraSourceAddress', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$2.SocketOptionsOverride>(2, _omitFieldNames ? '' : 'socketOptions', subBuilder: $2.SocketOptionsOverride.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $2.SocketOptionsOverride get socketOptions => $_getN(1);
  @$pb.TagNumber(2)
  set socketOptions($2.SocketOptionsOverride v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSocketOptions() => $_has(1);
  @$pb.TagNumber(2)
  void clearSocketOptions() => clearField(2);
  @$pb.TagNumber(2)
  $2.SocketOptionsOverride ensureSocketOptions() => $_ensure(1);
}
...
class BindConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BindConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$1.BoolValue>(2, _omitFieldNames ? '' : 'freebind', subBuilder: $1.BoolValue.create)
    ..pc<$2.SocketOption>(3, _omitFieldNames ? '' : 'socketOptions', $pb.PbFieldType.PM, subBuilder: $2.SocketOption.create)
    ...
    ..aOM<$3.TypedExtensionConfig>(6, _omitFieldNames ? '' : 'localAddressSelector', subBuilder: $3.TypedExtensionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $1.BoolValue get freebind => $_getN(1);
  @$pb.TagNumber(2)
  set freebind($1.BoolValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFreebind() => $_has(1);
  @$pb.TagNumber(2)
  void clearFreebind() => clearField(2);
  @$pb.TagNumber(2)
  $1.BoolValue ensureFreebind() => $_ensure(1);

  /// Additional socket options that may not be present in Envoy source code or
  /// precompiled binaries.
  @$pb.TagNumber(3)
  $core.List<$2.SocketOption> get socketOptions => $_getList(2);
  ...
  @$pb.TagNumber(6)
  $3.TypedExtensionConfig get localAddressSelector => $_getN(5);
  @$pb.TagNumber(6)
  set localAddressSelector($3.TypedExtensionConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasLocalAddressSelector() => $_has(5);
  @$pb.TagNumber(6)
  void clearLocalAddressSelector() => clearField(6);
  @$pb.TagNumber(6)
  $3.TypedExtensionConfig ensureLocalAddressSelector() => $_ensure(5);
}
...
class CidrRange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CidrRange', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ...
    ..aOM<$1.UInt32Value>(2, _omitFieldNames ? '' : 'prefixLen', subBuilder: $1.UInt32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $1.UInt32Value get prefixLen => $_getN(1);
  @$pb.TagNumber(2)
  set prefixLen($1.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPrefixLen() => $_has(1);
  @$pb.TagNumber(2)
  void clearPrefixLen() => clearField(2);
  @$pb.TagNumber(2)
  $1.UInt32Value ensurePrefixLen() => $_ensure(1);
}
