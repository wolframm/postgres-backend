...
class BackoffStrategy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BackoffStrategy', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.core.v3'), createEmptyInstance: create)
    ..aOM<$4.Duration>(1, _omitFieldNames ? '' : 'baseInterval', subBuilder: $4.Duration.create)
    ..aOM<$4.Duration>(2, _omitFieldNames ? '' : 'maxInterval', subBuilder: $4.Duration.create)
  ...
  @$pb.TagNumber(1)
  $4.Duration get baseInterval => $_getN(0);
  @$pb.TagNumber(1)
  set baseInterval($4.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBaseInterval() => $_has(0);
  @$pb.TagNumber(1)
  void clearBaseInterval() => clearField(1);
  @$pb.TagNumber(1)
  $4.Duration ensureBaseInterval() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $4.Duration get maxInterval => $_getN(1);
  @$pb.TagNumber(2)
  set maxInterval($4.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMaxInterval() => $_has(1);
  @$pb.TagNumber(2)
  void clearMaxInterval() => clearField(2);
  @$pb.TagNumber(2)
  $4.Duration ensureMaxInterval() => $_ensure(1);
}
