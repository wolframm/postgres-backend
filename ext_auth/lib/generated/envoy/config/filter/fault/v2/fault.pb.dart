...
class FaultDelay extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $0.Duration get fixedDelay => $_getN(1);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $0.Duration ensureFixedDelay() => $_ensure(1);

  /// The percentage of operations/connections/requests on which the delay will be injected.
  @$pb.TagNumber(4)
  $1.FractionalPercent get percentage => $_getN(2);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(4)
  $1.FractionalPercent ensurePercentage() => $_ensure(2);
