...
import '../../../../type/percent.pb.dart' as $3;
...
class AccessLog extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessLog', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.accesslog.v2'), createEmptyInstance: create)
    ...
    ..aOM<$0.Struct>(3, _omitFieldNames ? '' : 'config', subBuilder: $0.Struct.create)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  $0.Struct get config => $_getN(2);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  set config($0.Struct v) { setField(3, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  $0.Struct ensureConfig() => $_ensure(2);

  @$pb.TagNumber(4)
  $1.Any get typedConfig => $_getN(3);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(4)
  $1.Any ensureTypedConfig() => $_ensure(3);
}
...
class ComparisonFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ComparisonFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.accesslog.v2'), createEmptyInstance: create)
    ...
    ..aOM<$2.RuntimeUInt32>(2, _omitFieldNames ? '' : 'value', subBuilder: $2.RuntimeUInt32.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $2.RuntimeUInt32 get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($2.RuntimeUInt32 v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
  @$pb.TagNumber(2)
  $2.RuntimeUInt32 ensureValue() => $_ensure(1);
}
...
class RuntimeFilter extends $pb.GeneratedMessage {
  factory RuntimeFilter({
    ...
    $3.FractionalPercent? percentSampled,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.accesslog.v2'), createEmptyInstance: create)
    ...
    ..aOM<$3.FractionalPercent>(2, _omitFieldNames ? '' : 'percentSampled', subBuilder: $3.FractionalPercent.create)
  ...
  @$pb.TagNumber(2)
  $3.FractionalPercent get percentSampled => $_getN(1);
  @$pb.TagNumber(2)
  set percentSampled($3.FractionalPercent v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPercentSampled() => $_has(1);
  @$pb.TagNumber(2)
  void clearPercentSampled() => clearField(2);
  @$pb.TagNumber(2)
  $3.FractionalPercent ensurePercentSampled() => $_ensure(1);
...
class HeaderFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HeaderFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.accesslog.v2'), createEmptyInstance: create)
    ..aOM<$4.HeaderMatcher>(1, _omitFieldNames ? '' : 'header', subBuilder: $4.HeaderMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  /// check.
  @$pb.TagNumber(1)
  $4.HeaderMatcher get header => $_getN(0);
  @$pb.TagNumber(1)
  set header($4.HeaderMatcher v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasHeader() => $_has(0);
  @$pb.TagNumber(1)
  void clearHeader() => clearField(1);
  @$pb.TagNumber(1)
  $4.HeaderMatcher ensureHeader() => $_ensure(0);
}
