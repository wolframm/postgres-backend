...
const RateLimit$json = {
  ...
  '2': [
    ...
    {'1': 'rate_limit_service', '3': 5, '4': 1, '5': 11, '6': '.envoy.config.ratelimit.v2.RateLimitServiceConfig', '8': {}, '10': 'rateLimitService'},
  ],
};
...
final $typed_data.Uint8List rateLimitDescriptor = $convert.base64Decode(
    ...
    'bWl0LnYyLlJhdGVMaW1pdFNlcnZpY2VDb25maWdCCPpCBYoBAhABUhByYXRlTGltaXRTZXJ2aW'
    'Nl');
