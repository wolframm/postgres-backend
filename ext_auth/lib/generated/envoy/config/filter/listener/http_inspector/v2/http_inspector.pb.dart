...
class HttpInspector extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpInspector', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.filter.listener.http_inspector.v2'), createEmptyInstance: create)
