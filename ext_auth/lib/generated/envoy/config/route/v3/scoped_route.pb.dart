...
class ScopedRouteConfiguration extends $pb.GeneratedMessage {
  factory ScopedRouteConfiguration({
    ...
    $core.bool? onDemand,
    $16.RouteConfiguration? routeConfiguration,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScopedRouteConfiguration', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.config.route.v3'), createEmptyInstance: create)
    ...
    ..aOM<$16.RouteConfiguration>(5, _omitFieldNames ? '' : 'routeConfiguration', subBuilder: $16.RouteConfiguration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $16.RouteConfiguration get routeConfiguration => $_getN(4);
  @$pb.TagNumber(5)
  set routeConfiguration($16.RouteConfiguration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasRouteConfiguration() => $_has(4);
  @$pb.TagNumber(5)
  void clearRouteConfiguration() => clearField(5);
  @$pb.TagNumber(5)
  $16.RouteConfiguration ensureRouteConfiguration() => $_ensure(4);
}
