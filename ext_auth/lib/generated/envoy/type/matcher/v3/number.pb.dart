...
class DoubleMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DoubleMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.matcher.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3.DoubleRange>(1, _omitFieldNames ? '' : 'range', subBuilder: $3.DoubleRange.create)
  ...
  @$pb.TagNumber(1)
  $3.DoubleRange get range => $_getN(0);
  @$pb.TagNumber(1)
  set range($3.DoubleRange v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRange() => $_has(0);
  @$pb.TagNumber(1)
  void clearRange() => clearField(1);
  @$pb.TagNumber(1)
  $3.DoubleRange ensureRange() => $_ensure(0);
