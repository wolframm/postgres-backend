...
class NodeMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NodeMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type.matcher.v3'), createEmptyInstance: create)
    ..aOM<$2.StringMatcher>(1, _omitFieldNames ? '' : 'nodeId', subBuilder: $2.StringMatcher.create)
  ...
  @$pb.TagNumber(1)
  $2.StringMatcher get nodeId => $_getN(0);
  @$pb.TagNumber(1)
  set nodeId($2.StringMatcher v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasNodeId() => $_has(0);
  @$pb.TagNumber(1)
  void clearNodeId() => clearField(1);
  @$pb.TagNumber(1)
  $2.StringMatcher ensureNodeId() => $_ensure(0);
