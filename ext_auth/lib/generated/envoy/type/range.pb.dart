...
class Int64Range extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Int64Range', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type'), createEmptyInstance: create)
...
class Int32Range extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Int32Range', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type'), createEmptyInstance: create)
...
class DoubleRange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DoubleRange', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type'), createEmptyInstance: create)
