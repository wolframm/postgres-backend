...
class Percent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Percent', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type'), createEmptyInstance: create)
...
class FractionalPercent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FractionalPercent', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.type'), createEmptyInstance: create)
