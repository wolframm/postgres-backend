...
import '../../config/tap/v3/common.pb.dart' as $13;

/// The /tap admin request body that is used to configure an active tap session.
class TapRequest extends $pb.GeneratedMessage {
  factory TapRequest({
    $core.String? configId,
    $13.TapConfig? tapConfig,
  }) {
    final $result = create();
    if (configId != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TapRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.admin.v3'), createEmptyInstance: create)
    ...
    ..aOM<$13.TapConfig>(2, _omitFieldNames ? '' : 'tapConfig', subBuilder: $13.TapConfig.create)
  ...
  @$pb.TagNumber(2)
  $13.TapConfig get tapConfig => $_getN(1);
  @$pb.TagNumber(2)
  set tapConfig($13.TapConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTapConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearTapConfig() => clearField(2);
  @$pb.TagNumber(2)
  $13.TapConfig ensureTapConfig() => $_ensure(1);
}
