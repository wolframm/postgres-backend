...
class CertificateDetails_OcspDetails extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CertificateDetails.OcspDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.admin.v3'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, _omitFieldNames ? '' : 'validFrom', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(2, _omitFieldNames ? '' : 'expiration', subBuilder: $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $0.Timestamp get validFrom => $_getN(0);
  @$pb.TagNumber(1)
  set validFrom($0.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasValidFrom() => $_has(0);
  @$pb.TagNumber(1)
  void clearValidFrom() => clearField(1);
  @$pb.TagNumber(1)
  $0.Timestamp ensureValidFrom() => $_ensure(0);

  /// Indicates the time at which the OCSP response expires.
  @$pb.TagNumber(2)
  $0.Timestamp get expiration => $_getN(1);
  @$pb.TagNumber(2)
  set expiration($0.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
