...
class CommandLineOptions_DrainStrategy extends $pb.ProtobufEnum {
  static const CommandLineOptions_DrainStrategy Gradual = CommandLineOptions_DrainStrategy._(0, _omitEnumNames ? '' : 'Gradual');
  static const CommandLineOptions_DrainStrategy Immediate = CommandLineOptions_DrainStrategy._(1, _omitEnumNames ? '' : 'Immediate');

  static const $core.List<CommandLineOptions_DrainStrategy> values = <CommandLineOptions_DrainStrategy> [
    Gradual,
    Immediate,
  ];

  static final $core.Map<$core.int, CommandLineOptions_DrainStrategy> _byValue = $pb.ProtobufEnum.initByValue(values);
  static CommandLineOptions_DrainStrategy? valueOf($core.int value) => _byValue[value];

  const CommandLineOptions_DrainStrategy._($core.int v, $core.String n) : super(v, n);
}
