...
import '../../api/v2/core/health_check.pbenum.dart' as $5;
import '../../type/percent.pb.dart' as $1;
import 'metrics.pb.dart' as $3;
...
class HostStatus extends $pb.GeneratedMessage {
  factory HostStatus({
    $2.Address? address,
    $core.Iterable<$3.SimpleMetric>? stats,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HostStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.admin.v2alpha'), createEmptyInstance: create)
    ...
    ..pc<$3.SimpleMetric>(2, _omitFieldNames ? '' : 'stats', $pb.PbFieldType.PM, subBuilder: $3.SimpleMetric.create)
    ...
    ..aOM<$4.Locality>(9, _omitFieldNames ? '' : 'locality', subBuilder: $4.Locality.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$3.SimpleMetric> get stats => $_getList(1);
  ...
  @$pb.TagNumber(9)
  $4.Locality get locality => $_getN(8);
  @$pb.TagNumber(9)
  set locality($4.Locality v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasLocality() => $_has(8);
  @$pb.TagNumber(9)
  void clearLocality() => clearField(9);
  @$pb.TagNumber(9)
  $4.Locality ensureLocality() => $_ensure(8);
}
...
class HostHealthStatus extends $pb.GeneratedMessage {
  factory HostHealthStatus({
    ...
    $5.HealthStatus? edsHealthStatus,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HostHealthStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.admin.v2alpha'), createEmptyInstance: create)
    ...
    ..e<$5.HealthStatus>(3, _omitFieldNames ? '' : 'edsHealthStatus', $pb.PbFieldType.OE, defaultOrMaker: $5.HealthStatus.UNKNOWN, valueOf: $5.HealthStatus.valueOf, enumValues: $5.HealthStatus.values)
  ...
  @$pb.TagNumber(3)
  $5.HealthStatus get edsHealthStatus => $_getN(2);
  @$pb.TagNumber(3)
  set edsHealthStatus($5.HealthStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
