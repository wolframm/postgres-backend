...
class InjectedResourceConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InjectedResourceConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.resource_monitors.injected_resource.v3'), createEmptyInstance: create)
