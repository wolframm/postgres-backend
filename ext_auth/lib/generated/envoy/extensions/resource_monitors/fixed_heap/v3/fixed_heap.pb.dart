...
class FixedHeapConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FixedHeapConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.resource_monitors.fixed_heap.v3'), createEmptyInstance: create)
