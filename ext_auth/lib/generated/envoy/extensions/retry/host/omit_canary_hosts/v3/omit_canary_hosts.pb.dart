...
class OmitCanaryHostsPredicate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OmitCanaryHostsPredicate', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.retry.host.omit_canary_hosts.v3'), createEmptyInstance: create)
