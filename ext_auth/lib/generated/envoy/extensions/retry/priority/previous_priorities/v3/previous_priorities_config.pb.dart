...
class PreviousPrioritiesConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PreviousPrioritiesConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.retry.priority.previous_priorities.v3'), createEmptyInstance: create)
