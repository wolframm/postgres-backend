...
class Config_KeyValuePair extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Config.KeyValuePair', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.header_to_metadata.v3'), createEmptyInstance: create)
    ...
    ..aOM<$0.RegexMatchAndSubstitute>(6, _omitFieldNames ? '' : 'regexValueRewrite', subBuilder: $0.RegexMatchAndSubstitute.create)
  ...
  @$pb.TagNumber(6)
  $0.RegexMatchAndSubstitute get regexValueRewrite => $_getN(5);
  @$pb.TagNumber(6)
  set regexValueRewrite($0.RegexMatchAndSubstitute v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasRegexValueRewrite() => $_has(5);
  @$pb.TagNumber(6)
  void clearRegexValueRewrite() => clearField(6);
  @$pb.TagNumber(6)
  $0.RegexMatchAndSubstitute ensureRegexValueRewrite() => $_ensure(5);
}
