...
class AdaptiveConcurrency extends $pb.GeneratedMessage {
  factory AdaptiveConcurrency({
    ...
    $4.HttpStatus? concurrencyLimitExceededStatus,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdaptiveConcurrency', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.http.adaptive_concurrency.v3'), createEmptyInstance: create)
    ...
    ..aOM<$4.HttpStatus>(3, _omitFieldNames ? '' : 'concurrencyLimitExceededStatus', subBuilder: $4.HttpStatus.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4.HttpStatus get concurrencyLimitExceededStatus => $_getN(2);
  @$pb.TagNumber(3)
  set concurrencyLimitExceededStatus($4.HttpStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasConcurrencyLimitExceededStatus() => $_has(2);
  @$pb.TagNumber(3)
  void clearConcurrencyLimitExceededStatus() => clearField(3);
  @$pb.TagNumber(3)
  $4.HttpStatus ensureConcurrencyLimitExceededStatus() => $_ensure(2);
}
