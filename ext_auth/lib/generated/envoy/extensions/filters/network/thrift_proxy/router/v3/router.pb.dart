...
class Router extends $pb.GeneratedMessage {
  factory Router({
    $0.BoolValue? closeDownstreamOnUpstreamError,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Router', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.network.thrift_proxy.router.v3'), createEmptyInstance: create)
    ..aOM<$0.BoolValue>(1, _omitFieldNames ? '' : 'closeDownstreamOnUpstreamError', subBuilder: $0.BoolValue.create)
  ...
  @$pb.TagNumber(1)
  $0.BoolValue get closeDownstreamOnUpstreamError => $_getN(0);
  @$pb.TagNumber(1)
  set closeDownstreamOnUpstreamError($0.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCloseDownstreamOnUpstreamError() => $_has(0);
  @$pb.TagNumber(1)
  void clearCloseDownstreamOnUpstreamError() => clearField(1);
  @$pb.TagNumber(1)
  $0.BoolValue ensureCloseDownstreamOnUpstreamError() => $_ensure(0);
}
