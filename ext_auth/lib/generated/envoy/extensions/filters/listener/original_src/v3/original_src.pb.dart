...
class OriginalSrc extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OriginalSrc', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.listener.original_src.v3'), createEmptyInstance: create)
