...
class OriginalDst extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OriginalDst', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.filters.listener.original_dst.v3'), createEmptyInstance: create)
