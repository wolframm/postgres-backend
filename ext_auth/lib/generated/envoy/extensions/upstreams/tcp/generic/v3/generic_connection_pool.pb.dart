...
class GenericConnectionPoolProto extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenericConnectionPoolProto', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.extensions.upstreams.tcp.generic.v3'), createEmptyInstance: create)
