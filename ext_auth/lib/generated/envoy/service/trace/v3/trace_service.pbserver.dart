...
import 'trace_service.pb.dart' as $9;
import 'trace_service.pbjson.dart';

export 'trace_service.pb.dart';

abstract class TraceServiceBase extends $pb.GeneratedService {
  $async.Future<$9.StreamTracesResponse> streamTraces($pb.ServerContext ctx, $9.StreamTracesMessage request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'StreamTraces': return $9.StreamTracesMessage();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      case 'StreamTraces': return this.streamTraces(ctx, request as $9.StreamTracesMessage);
      default: throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
