...
import 'metrics_service.pb.dart' as $6;
...
abstract class MetricsServiceBase extends $pb.GeneratedService {
  $async.Future<$6.StreamMetricsResponse> streamMetrics($pb.ServerContext ctx, $6.StreamMetricsMessage request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'StreamMetrics': return $6.StreamMetricsMessage();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      case 'StreamMetrics': return this.streamMetrics(ctx, request as $6.StreamMetricsMessage);
      default: throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
