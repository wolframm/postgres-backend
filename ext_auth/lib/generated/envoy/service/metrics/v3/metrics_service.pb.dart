...
import '../../../../io/prometheus/client/metrics.pb.dart' as $0;
...
class StreamMetricsMessage extends $pb.GeneratedMessage {
  factory StreamMetricsMessage({
    ...
    $core.Iterable<$0.MetricFamily>? envoyMetrics,
  }) {
    final $result = create();
    if (identifier != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamMetricsMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.metrics.v3'), createEmptyInstance: create)
    ...
    ..pc<$0.MetricFamily>(2, _omitFieldNames ? '' : 'envoyMetrics', $pb.PbFieldType.PM, subBuilder: $0.MetricFamily.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$0.MetricFamily> get envoyMetrics => $_getList(1);
}
