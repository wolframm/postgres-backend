...
import 'event_reporting_service.pb.dart' as $6;
...
abstract class EventReportingServiceBase extends $pb.GeneratedService {
  $async.Future<$6.StreamEventsResponse> streamEvents($pb.ServerContext ctx, $6.StreamEventsRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'StreamEvents': return $6.StreamEventsRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      case 'StreamEvents': return this.streamEvents(ctx, request as $6.StreamEventsRequest);
      default: throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
