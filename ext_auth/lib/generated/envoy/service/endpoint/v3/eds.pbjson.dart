...
final $typed_data.Uint8List edsDummyDescriptor = $convert.base64Decode(
    'CghFZHNEdW1teTocmsWIHhcKFWVudm95LmFwaS52Mi5FZHNEdW1teQ==');

const $core.Map<$core.String, $core.dynamic> EndpointDiscoveryServiceBase$json = {
  '1': 'EndpointDiscoveryService',
  '2': [
    {'1': 'StreamEndpoints', '2': '.envoy.service.discovery.v3.DiscoveryRequest', '3': '.envoy.service.discovery.v3.DiscoveryResponse', '4': {}, '5': true, '6': true},
    {'1': 'DeltaEndpoints', '2': '.envoy.service.discovery.v3.DeltaDiscoveryRequest', '3': '.envoy.service.discovery.v3.DeltaDiscoveryResponse', '4': {}, '5': true, '6': true},
    {'1': 'FetchEndpoints', '2': '.envoy.service.discovery.v3.DiscoveryRequest', '3': '.envoy.service.discovery.v3.DiscoveryResponse', '4': {}},
  ],
  '3': {},
};
...
final $typed_data.Uint8List endpointDiscoveryServiceDescriptor = $convert.base64Decode(
    'ChhFbmRwb2ludERpc2NvdmVyeVNlcnZpY2USdAoPU3RyZWFtRW5kcG9pbnRzEiwuZW52b3kuc2'
    'VydmljZS5kaXNjb3ZlcnkudjMuRGlzY292ZXJ5UmVxdWVzdBotLmVudm95LnNlcnZpY2UuZGlz'
    'Y292ZXJ5LnYzLkRpc2NvdmVyeVJlc3BvbnNlIgAoATABEn0KDkRlbHRhRW5kcG9pbnRzEjEuZW'
    '52b3kuc2VydmljZS5kaXNjb3ZlcnkudjMuRGVsdGFEaXNjb3ZlcnlSZXF1ZXN0GjIuZW52b3ku'
    'c2VydmljZS5kaXNjb3ZlcnkudjMuRGVsdGFEaXNjb3ZlcnlSZXNwb25zZSIAKAEwARKRAQoORm'
    'V0Y2hFbmRwb2ludHMSLC5lbnZveS5zZXJ2aWNlLmRpc2NvdmVyeS52My5EaXNjb3ZlcnlSZXF1'
    'ZXN0Gi0uZW52b3kuc2VydmljZS5kaXNjb3ZlcnkudjMuRGlzY292ZXJ5UmVzcG9uc2UiIoLT5J'
    'MCHDoBKiIXL3YzL2Rpc2NvdmVyeTplbmRwb2ludHMaNoqklvMHMAouZW52b3kuY29uZmlnLmVu'
    'ZHBvaW50LnYzLkNsdXN0ZXJMb2FkQXNzaWdubWVudA==');
