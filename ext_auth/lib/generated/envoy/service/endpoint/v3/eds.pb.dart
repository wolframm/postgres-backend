...
class EndpointDiscoveryServiceApi {
  ...
  $async.Future<$0.DiscoveryResponse> streamEndpoints($pb.ClientContext? ctx, $0.DiscoveryRequest request) =>
    _client.invoke<$0.DiscoveryResponse>(ctx, 'EndpointDiscoveryService', 'StreamEndpoints', request, $0.DiscoveryResponse())
  ;
  $async.Future<$0.DeltaDiscoveryResponse> deltaEndpoints($pb.ClientContext? ctx, $0.DeltaDiscoveryRequest request) =>
    _client.invoke<$0.DeltaDiscoveryResponse>(ctx, 'EndpointDiscoveryService', 'DeltaEndpoints', request, $0.DeltaDiscoveryResponse())
  ;
  $async.Future<$0.DiscoveryResponse> fetchEndpoints($pb.ClientContext? ctx, $0.DiscoveryRequest request) =>
    _client.invoke<$0.DiscoveryResponse>(ctx, 'EndpointDiscoveryService', 'FetchEndpoints', request, $0.DiscoveryResponse())
  ;
}
