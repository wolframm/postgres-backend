...
class HttpHeadersMatch extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpHeadersMatch', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.tap.v2alpha'), createEmptyInstance: create)
    ..pc<$1.HeaderMatcher>(1, _omitFieldNames ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: $1.HeaderMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$1.HeaderMatcher> get headers => $_getList(0);
}
...
class OutputConfig extends $pb.GeneratedMessage {
  factory OutputConfig({
    ...
    $2.UInt32Value? maxBufferedRxBytes,
    $2.UInt32Value? maxBufferedTxBytes,
    $core.bool? streaming,
  }) {
    final $result = create();
    if (sinks != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OutputConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.tap.v2alpha'), createEmptyInstance: create)
    ...
    ..aOM<$2.UInt32Value>(2, _omitFieldNames ? '' : 'maxBufferedRxBytes', subBuilder: $2.UInt32Value.create)
    ..aOM<$2.UInt32Value>(3, _omitFieldNames ? '' : 'maxBufferedTxBytes', subBuilder: $2.UInt32Value.create)
  ...
  /// default is 1KiB.
  @$pb.TagNumber(2)
  $2.UInt32Value get maxBufferedRxBytes => $_getN(1);
  @$pb.TagNumber(2)
  set maxBufferedRxBytes($2.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMaxBufferedRxBytes() => $_has(1);
  @$pb.TagNumber(2)
  void clearMaxBufferedRxBytes() => clearField(2);
  @$pb.TagNumber(2)
  $2.UInt32Value ensureMaxBufferedRxBytes() => $_ensure(1);
  ...
  /// default is 1KiB.
  @$pb.TagNumber(3)
  $2.UInt32Value get maxBufferedTxBytes => $_getN(2);
  @$pb.TagNumber(3)
  set maxBufferedTxBytes($2.UInt32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMaxBufferedTxBytes() => $_has(2);
  @$pb.TagNumber(3)
  void clearMaxBufferedTxBytes() => clearField(3);
  @$pb.TagNumber(3)
  $2.UInt32Value ensureMaxBufferedTxBytes() => $_ensure(2);
...
class StreamingGrpcSink extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingGrpcSink', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.tap.v2alpha'), createEmptyInstance: create)
    ...
    ..aOM<$3.GrpcService>(2, _omitFieldNames ? '' : 'grpcService', subBuilder: $3.GrpcService.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $3.GrpcService get grpcService => $_getN(1);
  @$pb.TagNumber(2)
  set grpcService($3.GrpcService v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasGrpcService() => $_has(1);
  @$pb.TagNumber(2)
  void clearGrpcService() => clearField(2);
  @$pb.TagNumber(2)
  $3.GrpcService ensureGrpcService() => $_ensure(1);
}
