...
import '../../../data/tap/v2alpha/wrapper.pb.dart' as $4;
...
class StreamTapsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamTapsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.tap.v2alpha'), createEmptyInstance: create)
    ...
    ..aOM<$4.TraceWrapper>(3, _omitFieldNames ? '' : 'trace', subBuilder: $4.TraceWrapper.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The trace data.
  @$pb.TagNumber(3)
  $4.TraceWrapper get trace => $_getN(2);
  @$pb.TagNumber(3)
  set trace($4.TraceWrapper v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasTrace() => $_has(2);
  @$pb.TagNumber(3)
  void clearTrace() => clearField(3);
  @$pb.TagNumber(3)
  $4.TraceWrapper ensureTrace() => $_ensure(2);
}
