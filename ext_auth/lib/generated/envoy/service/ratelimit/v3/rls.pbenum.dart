...
class RateLimitResponse_RateLimit_Unit extends $pb.ProtobufEnum {
  ...
  static const RateLimitResponse_RateLimit_Unit MONTH = RateLimitResponse_RateLimit_Unit._(5, _omitEnumNames ? '' : 'MONTH');
  static const RateLimitResponse_RateLimit_Unit YEAR = RateLimitResponse_RateLimit_Unit._(6, _omitEnumNames ? '' : 'YEAR');
