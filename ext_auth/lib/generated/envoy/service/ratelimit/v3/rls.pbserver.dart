...
import 'rls.pb.dart' as $5;
import 'rls.pbjson.dart';

export 'rls.pb.dart';

abstract class RateLimitServiceBase extends $pb.GeneratedService {
  $async.Future<$5.RateLimitResponse> shouldRateLimit($pb.ServerContext ctx, $5.RateLimitRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'ShouldRateLimit': return $5.RateLimitRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      case 'ShouldRateLimit': return this.shouldRateLimit(ctx, request as $5.RateLimitRequest);
      default: throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
