...
class ScopedRoutesDiscoveryServiceApi {
  ...
  $async.Future<$0.DiscoveryResponse> streamScopedRoutes($pb.ClientContext? ctx, $0.DiscoveryRequest request) =>
    _client.invoke<$0.DiscoveryResponse>(ctx, 'ScopedRoutesDiscoveryService', 'StreamScopedRoutes', request, $0.DiscoveryResponse())
  ;
  $async.Future<$0.DeltaDiscoveryResponse> deltaScopedRoutes($pb.ClientContext? ctx, $0.DeltaDiscoveryRequest request) =>
    _client.invoke<$0.DeltaDiscoveryResponse>(ctx, 'ScopedRoutesDiscoveryService', 'DeltaScopedRoutes', request, $0.DeltaDiscoveryResponse())
  ;
  $async.Future<$0.DiscoveryResponse> fetchScopedRoutes($pb.ClientContext? ctx, $0.DiscoveryRequest request) =>
    _client.invoke<$0.DiscoveryResponse>(ctx, 'ScopedRoutesDiscoveryService', 'FetchScopedRoutes', request, $0.DiscoveryResponse())
  ;
}
