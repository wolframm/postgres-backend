...
class Runtime extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Runtime', package: const $pb.PackageName(_omitMessageNames ? '' : 'envoy.service.discovery.v2'), createEmptyInstance: create)
    ...
    ..aOM<$2.Struct>(2, _omitFieldNames ? '' : 'layer', subBuilder: $2.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $2.Struct get layer => $_getN(1);
  @$pb.TagNumber(2)
  set layer($2.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLayer() => $_has(1);
  @$pb.TagNumber(2)
  void clearLayer() => clearField(2);
  @$pb.TagNumber(2)
  $2.Struct ensureLayer() => $_ensure(1);
}
...
class RuntimeDiscoveryServiceApi {
  ...
  $async.Future<$0.DiscoveryResponse> streamRuntime($pb.ClientContext? ctx, $0.DiscoveryRequest request) =>
    _client.invoke<$0.DiscoveryResponse>(ctx, 'RuntimeDiscoveryService', 'StreamRuntime', request, $0.DiscoveryResponse())
  ;
  $async.Future<$0.DeltaDiscoveryResponse> deltaRuntime($pb.ClientContext? ctx, $0.DeltaDiscoveryRequest request) =>
    _client.invoke<$0.DeltaDiscoveryResponse>(ctx, 'RuntimeDiscoveryService', 'DeltaRuntime', request, $0.DeltaDiscoveryResponse())
  ;
  $async.Future<$0.DiscoveryResponse> fetchRuntime($pb.ClientContext? ctx, $0.DiscoveryRequest request) =>
    _client.invoke<$0.DiscoveryResponse>(ctx, 'RuntimeDiscoveryService', 'FetchRuntime', request, $0.DiscoveryResponse())
  ;
}
