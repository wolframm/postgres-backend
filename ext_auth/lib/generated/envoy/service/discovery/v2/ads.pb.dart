...
class AggregatedDiscoveryServiceApi {
  ...
  $async.Future<$0.DiscoveryResponse> streamAggregatedResources($pb.ClientContext? ctx, $0.DiscoveryRequest request) =>
    _client.invoke<$0.DiscoveryResponse>(ctx, 'AggregatedDiscoveryService', 'StreamAggregatedResources', request, $0.DiscoveryResponse())
  ;
  $async.Future<$0.DeltaDiscoveryResponse> deltaAggregatedResources($pb.ClientContext? ctx, $0.DeltaDiscoveryRequest request) =>
    _client.invoke<$0.DeltaDiscoveryResponse>(ctx, 'AggregatedDiscoveryService', 'DeltaAggregatedResources', request, $0.DeltaDiscoveryResponse())
  ;
}
